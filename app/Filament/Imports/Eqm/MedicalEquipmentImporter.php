...
use App\Models\Eqm\Category; // Modelo para 'category'
use App\Models\Eqm\Subcategory; // Modelo para 'subcategory'
use App\Models\Eqm\Brand; // Modelo para 'brand'
use App\Models\Eqm\Supplier; // Modelo para 'supplier'
use Filament\Actions\Imports\ImportColumn;
use Filament\Actions\Imports\Importer;
use Filament\Actions\Imports\Models\Import;

class MedicalEquipmentImporter extends Importer
{
    ...
    {
        $body = 'Your medic equipment import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
